...
import com.pgigi.pumpkintoolkit.components.animation.DampedDragAnimation
import com.pgigi.pumpkintoolkit.components.liquid.InnerShadow
import com.pgigi.pumpkintoolkit.components.liquid.innerShadow
import com.pgigi.pumpkintoolkit.components.liquid.lens
import com.pgigi.pumpkintoolkit.components.liquid.rememberCombinedBackdrop
import com.pgigi.pumpkintoolkit.components.liquid.vibrancy
...
private object NoOpBackdrop : Backdrop {
...
fun <T> FloatingBottomBar(
    ...
    val effectiveBackdrop = backdrop ?: NoOpBackdrop
    ...
    val combinedBackdrop = rememberCombinedBackdrop(effectiveBackdrop, tabsBackdrop)
        ...
        CompositionLocalProvider(LocalFloatingBottomBarContentColor provides colors.contentColor) {
            Row(
                Modifier
                    ...
                    .shadow(
                        elevation = if (isInDark) 8.dp else 4.dp,
                        shape = pillShape,
                        clip = false,
                    )
                    .then(
